...
BUILD_DB_PATH = BASE_DIR / 'Operation History' / 'Scripts' / 'Build Database'
...
# Reviewers: modify this line and ensure you're picking the correct SQL schema 
SQL_SCHEMA_PATH = BUILD_DB_PATH / 'generate_dirty_dataset_database.sql'
